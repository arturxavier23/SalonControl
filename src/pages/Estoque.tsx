  ...
  return (
    <Layout>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <div className="space-y-6">
          ...
          >
            ...
            <div>
              ...
              <textarea
                className="w-full bg-surface-2 border border-line rounded-lg px-3 py-2 outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 min-h-20"
        ...
        <div className="xl:col-span-2 bg-surface border border-line rounded-2xl shadow-lg shadow-black/5 backdrop-blur-sm p-5">
          ...
          {carregando ? (
            <p className="text-ink-muted">Carregando produtos...</p>
